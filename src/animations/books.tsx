...
function BookGrid({ books, handleSelectBook, ...delegated }: BookGridProps) {
  return (
    <section {...delegated}>
      <ul className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] content-start gap-2 p-4 rounded-lg min-h-full bg-white list-none">
        {books.map((book) => (
          <li key={book.isbn}>
            <button
            ...
            >
              <motion.img
                ...
                alt={book.name}
                src={book.coverSrc}
                className="block object-cover rounded border-none w-full h-full will-change-transform"
                draggable={false}
              />
            </button>
          </li>
...
function ReadingList({
  ...
  return (
    <MotionConfig transition={transition}>
      <div
        className="w-[300px] p-4 bg-gray-950 text-white"
        onMouseLeave={() => {
...
const DATA = [
  {
    ...
    coverSrc: "/images/book-covers/winters-orbit.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/small-angry.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Becky Chambers",
    coverSrc: "/images/book-covers/common-orbit.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Becky Chambers",
    coverSrc: "/images/book-covers/spaceborn.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Becky Chambers",
    coverSrc: "/images/book-covers/ground-within.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/deadman.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Scott Meyer",
    coverSrc: "/images/book-covers/wizard.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Scott Meyer",
    coverSrc: "/images/book-covers/formalities.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Scott Meyer",
    coverSrc: "/images/book-covers/authorities.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/bob.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/mckeown.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/hank.jpg",
    abstract:
  ...
  },
  {
    ...
    name: "Artemis Fowl",
    author: "Eoin Colfer",
    coverSrc: "/images/book-covers/fowl.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Randee Dawn",
    coverSrc: "/images/book-covers/tune-in-tomorrow.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/station-eleven.jpg",
    abstract:
  ...
  },
  {
    ...
    name: "Old Man's War",
    author: "John Scalzi",
    coverSrc: "/images/book-covers/old-mans-war.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "N.K. Jemisin",
    coverSrc: "/images/book-covers/fifth-season.jpg",
    abstract:
  ...
  },
  {
    ...
    name: "Ocean’s Echo",
    author: "Everina Maxwell",
    coverSrc: "/images/book-covers/oceans-echo.jpg",
    abstract:
  ...
  },
  {
    ...
    coverSrc: "/images/book-covers/dreadnought.jpg",
    abstract:
  ...
  },
  {
    ...
    author: "Freya Marske",
    coverSrc: "/images/book-covers/marvellous-light.jpg",
    abstract:
